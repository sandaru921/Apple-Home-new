              ...
              <form onSubmit={handlePasswordChange} className="space-y-6">
                ...
                <div className="pt-4 flex justify-end">
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-8 py-4 bg-[#7CB342] text-white rounded-xl font-bold hover:bg-[#689f38] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 shadow-md hover:shadow-lg"
                  >
