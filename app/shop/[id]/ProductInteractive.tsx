...
import { ShoppingCart, ArrowLeft, Check, Zap, ChevronDown, ChevronUp, ShieldCheck, Battery } from 'lucide-react';
...
export default function ProductInteractive({ 
  ...
  const [selectedStorage, setSelectedStorage] = useState<string>(product.storageOptions?.[0]?.capacity || '');
  const [selectedStoragePrice, setSelectedStoragePrice] = useState<number>(
    product.storageOptions?.[0]?.price || product.basePrice || product.price || 0
  );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-12 flex flex-col bg-white">
            ...
            <div className="flex flex-wrap gap-2 mb-6 pb-6 border-b border-gray-100">
              ...
              {product.batteryHealth !== undefined && product.batteryHealth !== null && (
              ...
              {product.isUnlocked !== undefined && product.isUnlocked !== null && (
